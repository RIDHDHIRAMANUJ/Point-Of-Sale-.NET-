                                                ...
                                                <asp:Repeater ID="rContacts" runat="server" OnItemCommand="rContacts_ItemCommand">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CssClass="badge bg-danger" CommandArgument='<%# Eval("ContactId") %>' CommandName="delete" OnClientClick="return confirm('Do you want to delete this record?');">
                                                                       <i class="ti-trash"></i>
                                                                </asp:LinkButton>
                                                            </td>
