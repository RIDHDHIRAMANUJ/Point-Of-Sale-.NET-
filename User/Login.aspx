            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-container">
                        <img id="userLogin" src="../Images/login.jpg" alt="Login Image" class="img-thumbnail">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-container">
                    ...
                    <!-- Add space between Username and Password fields -->
                    <div class="form-container mt-4"> <!-- Added mt-3 for margin-top -->
